...
이제 위의 그림처럼 $\overrightarrow V$의 길이를 두 배로하여 대칭성을 깨뜨리고 $\overrightarrow W$를 $2\overrightarrow V$ 에 projection 시키면 $$\overrightarrow W\cdot(2\overrightarrow V)=2(\overrightarrow W\cdot\overrightarrow V)$$ 임을 당연하게 이끌어낼 수 있습니다. 왜냐하면 $\lvert projected \overrightarrow W\rvert$는 그대로이기 떄문입니다. 
