...
와 같이 정리할 수 있으며 이를 <b>_Matrix-Vector Multiplication_</b> 라고 표현합니다. 추가로 $\begin{equation}\begin{bmatrix}2& -2 \\ 1 & -1\end{bmatrix}\end{equation}$ 와 같이 두 벡터가 linearly dependent 하다면 해당 변환은 공간을 squish 시켜 모든 벡터를 해당 line에 놓여있게 합니다. 
