---
layout: single
title:  "Essence of Linear Algebra_01"
categories: 
 - Linear Algebra
classes: wide
use_math: true
...
<span style='color:#808080'>_모든 첨부 이미지는 3Blue1Brown에 저작권이 있습니다_</span> 
...
<center><video src="https://user-images.githubusercontent.com/33462847/214818086-4002ec31-aad4-4997-bdab-7fde03f554db.mp4" controls="controls" height="70%" width="70%"></video></center>
...
와 같이 정리할 수 있으며 이를 <b>_Matrix-Vector Multiplication_</b> 라고 표현합니다. 추가로 $\begin{bmatrix}2&-2 \\ 1&-1\end{bmatrix}$ 와 같이 두 벡터가 linearly dependent 하다면 해당 변환은 공간을 squish 시켜 모든 벡터를 해당 line에 놓여있게 합니다. 
